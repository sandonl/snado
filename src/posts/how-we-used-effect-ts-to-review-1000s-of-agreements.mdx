---
title: "How we used Effect.ts to review thousands of agreements"
...
We built it with [Effect](https://effect.website/) - a toolkit for keeping complex software reliable as it scales. What follows is a walk through the problems we hit, and how Effect helped us navigate each one.
...
Typed errors mean failures can't slip through unhandled. Layers mean dependencies are explicit and swappable. Semaphores mean concurrency is controlled and throttled accordingly.
